            ...
            <motion.div variants={itemVariants} key={stat.label} className="bg-white rounded-2xl border border-[#e3e8ef] px-6 py-6 flex flex-col gap-4 shadow-[0_1px_1px_rgba(0,0,0,0.05),0_2px_4px_rgba(34,42,66,0.03)] hover:shadow-[0_8px_24px_rgba(60,66,87,0.1)] hover:-translate-y-0.5 transition-all duration-300 group">
              <div className="flex items-center justify-between">
                ...
                <div className="w-9 h-9 rounded-xl bg-[#f6f9fc] flex items-center justify-center border border-[#e3e8ef]/50 group-hover:bg-[#635bff]/5 group-hover:border-[#635bff]/20 transition-all duration-300 shadow-sm">
                  <Icon className="w-4 h-4 text-[#8792a2] group-hover:text-[#635bff] group-hover:scale-110 transition-all duration-300" />
                </div>
              </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="bg-white rounded-2xl border border-[#e3e8ef] shadow-[0_1px_1px_rgba(0,0,0,0.05),0_4px_6px_rgba(34,42,66,0.04)] overflow-hidden">
          ...
          <div className="px-4 py-4 border-t border-[#f0f3f7] bg-[#fcfdfe]">
            <Link href="/connections" className="flex items-center justify-center gap-2 w-full px-4 py-2.5 rounded-xl text-[12px] font-bold text-[#3c4257] bg-white border border-[#e3e8ef] hover:bg-white hover:border-[#635bff]/30 hover:shadow-md transition-all active:scale-[0.98]">
              <Plus className="w-3.5 h-3.5 text-[#635bff]" />Manage all connections
            </Link>
          </div>
        </motion.div>
      </div>

      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="p-8 rounded-3xl border border-[#635bff]/10 bg-gradient-to-br from-[#f8faff] to-[#f0eeff] relative overflow-hidden group hover:shadow-2xl hover:shadow-[#635bff]/5 transition-all duration-500">
